...
const questionSets = [
    ...
    {
        title: 'Lambda1_1',
        subtitle: 'Lambdaの基本概念・関数・実行環境',
        description: 'サーバーレス、ハンドラー、ランタイム、コールドスタート、基本設定',
        to: '/lambda/lambda1_1',
        level: 'Basic',
        tone: 'cyan',
    },
    {
        title: 'Lambda1_2',
        subtitle: 'Lambdaの呼び出し・連携・権限',
        description: '手動実行、トリガー、S3/API Gateway/SQS連携、IAM実行ロール',
        to: '/lambda/lambda1_2',
        level: 'Basic',
        tone: 'teal',
    },
    {
        title: 'Lambda1_3',
        subtitle: 'Lambdaの運用・失敗時挙動・使いどころ',
        description: 'ログ、トラブルシュート、リトライ、冪等性、向くケースと向かないケース',
        to: '/lambda/lambda1_3',
        level: 'Basic',
        tone: 'slate',
    },
    {
        title: 'Lambda2_1',
        subtitle: 'Lambdaの採用判断・性能・非同期設計',
        description: 'アーキテクチャ選定、コールドスタート、冪等性、DLQ/Destination',
        to: '/lambda/lambda2_1',
        level: 'Advanced',
        tone: 'indigo',
    },
    {
        title: 'Lambda2_2',
        subtitle: 'Lambdaのイベント連携・API・VPC',
        description: 'SQS/Kinesis/Streams、API Gateway、Function URL、VPC接続',
        to: '/lambda/lambda2_2',
        level: 'Advanced',
        tone: 'purple',
    },
    {
        title: 'Lambda2_3',
        subtitle: 'LambdaのDB接続・セキュリティ・監視',
        description: 'RDS Proxy、DynamoDB使い分け、IAM高度化、運用メトリクス',
        to: '/lambda/lambda2_3',
        level: 'Advanced',
        tone: 'red',
    },
    {
        title: 'Lambda2_4',
        subtitle: 'Lambdaの同時実行・デプロイ・実運用',
        description: 'スロットリング、バージョン管理、コスト最適化、大規模運用',
        to: '/lambda/lambda2_4',
        level: 'Advanced',
        tone: 'slate',
    },
